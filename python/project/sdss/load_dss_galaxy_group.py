...
if __name__ == "__main__":
    galaxy_file = 'C:/carlos/oneDrive/data-science/TFM/tfm/data/groups/sdss/SDSS7_galaxy.csv'
    groups_file = 'C:/carlos/oneDrive/data-science/TFM/tfm/data/groups/sdss/SDSS7_galaxy_group.csv'
    destiny = 'C:/carlos/oneDrive/data-science/TFM/tfm/data/groups/sdss/SDSS7-valid.csv'
