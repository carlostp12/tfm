...
```{r}
galaxyClusters <- findClusters(galaxyDens, rho=0.999, delta=0.0025)
density_points <- points[galaxyClusters$peaks,]
length(galaxyClusters$peaks)
plot3d(density_points$x, density_points$y, density_points$z, col = 'BLACK', 
        size = 4, xlab = "X", ylab = "Y", zlab = "Z")
```
