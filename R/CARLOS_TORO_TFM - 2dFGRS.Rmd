...
$$RA \in [0, 30]h,\, DEC \in [-36, -25]º,\, \,and\,\, z \lt max\_redshift$$
...
In which case, we can see that $\delta=0.00084$ and $\rho=0.9985$ produce the best results with a 97% of group-centers detection.
...
+-------------------------------+----------------+-----------------------------+--------------------------------------------------------------------------+
| DBSCAN                        | Non-scaled     | P: 0.65                     | Good in cluster detection                                                |
|                               |                |                             |                                                                          |
|                               |                | C: 0.87                     |                                                                          |
|                               |                |                             |                                                                          |
|                               |                | R: 0.42                     |                                                                          |
...
In conclusion. We took for this study a sample from the 2dFGRS catalog and selected 6173 objects within an area between 0 and 1h in RA and -25 and -36º in DEC. We tried several methods in groups detecting selecting groups with a minimum of 5 elements (galaxies), we got 95 groups.
