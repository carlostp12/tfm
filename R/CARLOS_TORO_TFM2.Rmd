...
setwd('C:/Carlos/OneDrive/data-science/TFM/tfm/data')
...
ppplot_purity_completeness(x_stats, names,  "Purity and completeness", 0.00055, "eps", "perc")
```
...
As said from theory, HDBSCAN does not fit a great model because it ability to detect clusters in sparser areas

FROM <https://www.geeksforgeeks.org/r-language/how-to-plot-3d-scatter-diagram-using-ggplot-in-r/>
