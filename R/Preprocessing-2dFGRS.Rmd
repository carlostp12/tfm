...
# Clustering problem on dataset

We want, in this work apply some clustering algorithms, and the compare the obtained results with the
halo-based group finder optimized for grouping galaxies that reside in the same dark matter halo.
...
We want to see whether any clustering algorithm with some hyperparameters configuration is able to modelize the data given by the halo-based finder.
...
In the previous plot we can see how OPTICS modelize in valleys (clusters) and the peaks (clusters separation).
