...
eps_sequence_test <- seq(0.0002, 0.001, 0.0002)
...
original_mm$cluster_id <- galaxyClusters$cluster
```

```{r}
all <- execute_stats(original_mm, galaxyClusters)
print_stats(all)
...
peaks <- original_mm[galaxyClusters$peaks,]
...
Note that DPC is good in obtaining groups centers but not in separate the groups over the global database as we can see

```{r}
plot3d(original_mm$x, original_mm$y, original_mm$z, col = original_mm$cluster_id+1,        size = 3, xlab = "X", ylab = "Y", zlab = "Z")
```

![](images/paste-E4C2ADAB.png)
...
#optimal value found at 0.00015
 eps_sequence_test <- seq(0.000075, 0.000120, 0.000005)
...
+-------------------------------+----------------+-----------------------------+----------------------------------------------------------------------------------------------------+
| DBSCAN                        | Non-scaled     | P: 0.65                     | Good in cluster detection but low recovery. Which indicates the groups are not globally recovered. |
|                               |                |                             |                                                                                                    |
|                               |                | C: 0.87                     |                                                                                                    |
|                               |                |                             |                                                                                                    |
|                               |                | R: 0.42                     |                                                                                                    |
...
|                               |                |                             |                                                                                                    |
|                               |                |                             | $\delta=0.00083$ and $\rho=0.9985$                                                                 |
+-------------------------------+----------------+-----------------------------+----------------------------------------------------------------------------------------------------+
| **sOPTICS**                   | **Non-scaled** | **P: 0.92**                 | **Good on group detection with**                                                                   |
|                               |                |                             |                                                                                                    |
|                               |                | **C: 0.69**                 | **eps=0.0001**                                                                                     |
|                               |                |                             |                                                                                                    |
|                               |                | **R: 0.81**                 |                                                                                                    |
...
+-------------------------------+----------------+-----------------------------+----------------------------------------------------------------------------------------------------+
| DBSCAN                        | Scaled         | P: 0.82                     | Good in cluster detection with                                                                     |
|                               |                |                             |                                                                                                    |
|                               |                | C: 0.50                     | eps = 0.04 but low recovery. Which indicates the groups are not globally recovered.                |
|                               |                |                             |                                                                                                    |
|                               |                | R: 0.37                     |                                                                                                    |
|                               |                |                             |                                                                                                    |
|                               |                | U: 33                       |                                                                                                    |
...
-   The method sOPTICS with DBSCAN reached the highest values in completeness, purity and recovery and in group detection (77%).
...
Best detected groups with sOPTICS:

![](images/paste-D8BDF3E5.png)

While original Groups:
