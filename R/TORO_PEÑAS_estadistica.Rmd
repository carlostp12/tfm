...
Select groups with more than 5 members
...
We have on one hand all groups with more than 5 members:
...
ress <- optics(points_scaled, minPts = 5)
...
sres <- optics(dist_object, minPts = 5)
plot(sres)
```
