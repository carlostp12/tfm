...
This work primary focuses on the application of density-based algorithms to datasets obtained from various surveys, such as the Two-degree Field Galaxy Redshift Survey (2dFGRS) and the Sloan Digital Sky Survey (SDSS). As a result of this application, hyper-parameter tunning and an assessment will be conducted to identify the strengths and weaknesses of these algorithms in actual galactic group detection. In the future, these algorithms may be applied to new surveys and other regions of the sky.
