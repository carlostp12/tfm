...
\hline
 ...
 DPC & $\begin{matrix} \rho = 8.3 \times  10^{-4} \\ \delta = 0.9985 \end{matrix} $  & Non-scaled & - & - & Cluster-center detection did not match. \\  \hline
...
\hline
 ...
 DPC & $\begin{matrix} \rho = 8.0 \times  10^{-4} \\ \delta = 0.9985 \end{matrix} $  & Non-scaled & - & - & Cluster-center detection did not match. \\  \hline
...
\hline
 ...
 DPC & $\begin{matrix} \rho = 8.5 \times 10^{-4} \\ \delta = 0.9986 \end{matrix} $  & Non-scaled & - & - & Cluster-center detection did not match. \\  \hline
