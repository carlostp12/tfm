...
Finally, the SDSS 'Real Space Galaxy Catalogue' was incorporated, which provides galaxy coordinates reconstructed to account for redshift distortions as was explained in sections \ref{section:real} and \ref{section:slos}. This enables a robust comparison between observed clustering and theoretical predictions by isolating the isotropic real-space correlation function.
...
With these concepts we evaluate the ratios, respectively \textit{Purity-rate}, \textit{Completeness-rate} and \textit{Completeness-Pure-Rate} as:
...
All sources used for this study and code can be downloaded from \href{https://github.com/carlostp12/tfm}{this link in Github}.	