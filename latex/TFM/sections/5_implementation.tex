...
\section{Two-points correlation function estimator}
According to \cite{Kerscher:2000} the recommended estimator is the Andy and Szalay (1993) given by the equation \ref{eq:2_1}:
