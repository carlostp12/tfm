...
We want, in this work apply some clustering algorithms, and the compare the obtained models with the
...
sblo_scan <- extractDBSCAN(sres, eps_cl = 0.000108)
mm$cluster_id <- sblo_scan$cluster
